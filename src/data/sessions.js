...
export const sessions = {
  ...
  D: {
    ...
    exercises: [
      ...
      },
      {
        ...
        note: "Surcharge lourde. Prends des charges lourdes, garde le buste droit et avance.",
        tempo: "N/A",
        sets: 3,
        reps: "45-60",
        unit: "seconds",
  ...
  E: {
    category: "Bras",
    title: "Séance E : Bras (Énormes & Secs)",
    focus: "Hypertrophie Totale Biceps, Triceps & Avant-bras",
    color: "from-orange-600 to-orange-800",
    exercises: [
      {
        id: "e1",
        muscle: "Biceps (Long Chef)",
        name: "Curl Bayésien (Bayesian Cable Curl)",
        note: "Tension continue, étirement extrême en arrière. Parfait pour le pic du biceps et la définition.",
        tempo: "3-0-1-1",
        sets: 4,
        reps: "10-12",
        rest: 90,
      ...
      {
        id: "e2",
        muscle: "Biceps (Court Chef)",
        name: "Curl Biceps Machine (Bicep Curl Machine)",
        note: "Isole parfaitement les biceps. Focus sur la contraction maximale pour des bras secs et striés.",
        tempo: "2-0-1-1",
        sets: 4,
        reps: "10-15",
        rest: 90,
      },
      {
        ...
        name: "Dips Machine ou Lestés (Dips for Triceps)",
        note: "Buste droit, coudes près du corps. Le meilleur bâtisseur de masse globale pour les triceps.",
        tempo: "2-0-1-0",
        sets: 4,
        reps: "8-12",
        rest: 90,
      },
      {
        ...
        name: "Extension Triceps Poulie Haute (Triceps Pushdown)",
        note: "À la barre ou corde. Cible le fer à cheval du triceps pour un aspect très sec.",
        tempo: "2-0-1-1",
        sets: 3,
        reps: "12-15",
        rest: 75,
      },
      {
        ...
        name: "Extension Nuque Haltère (Overhead Dumbbell Extension)",
        note: "Essentiel pour cibler la longue portion du triceps et obtenir un volume maximal du bras.",
        tempo: "3-0-1-0",
        sets: 3,
        reps: "10-12",
        rest: 90,
      },
      {
        id: "e6",
        muscle: "Brachial",
        name: "Curl Marteau Corde à la Poulie (Rope Hammer Curl)",
        note: "Pousse le biceps vers le haut et donne une épaisseur 3D impressionnante au bras.",
        tempo: "2-0-1-0",
        sets: 3,
        reps: "10-12",
        rest: 75,
      },
      {
        id: "e7",
        muscle: "Avant-bras",
        name: "Curl Inversé Barre EZ (Reverse EZ-Bar Curl)",
        note: "Grosse congestion du long supinateur. Finition indispensable pour des avant-bras massifs.",
        tempo: "2-0-1-0",
        sets: 3,
        reps: "12-15",
        rest: 60,
